                ...
                <ul class="metismenu" id="menu">
                    ...
                    @if ($usr->can('order.view') ||  $usr->can('role.edit') ||  $usr->can('order.delete'))
                        <li class="active">
                            ...
                            <ul class="collapse">
                                <li class="{{ Route::is('admin.requests') ? 'active' : '' }}"><a href="{{ route('admin.requests') }}">Orders</a></li>
                            </ul>
                        </li>
                    @endif
                    ...
                    <li>
                        ...
                        <ul class="collapse {{ Route::is('admin.admins.create') || Route::is('admin.admins.index') || Route::is('admin.admins.edit') || Route::is('admin.admins.show') ? 'in' : '' }}">
                            ...
                            @if ($usr->can('admin.create'))
                                <li class="{{ Route::is('admin.admins.create')  ? 'active' : '' }}"><a href="{{ route('admin.admins.create') }}">Create Users</a></li>
                            @endif
                        </ul>
                    </li>
                    @endif
