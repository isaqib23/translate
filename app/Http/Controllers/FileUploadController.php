...
class FileUploadController extends Controller
{
    public function upload(Request $request)
    {
        ...
        //if($checkInput["type"] == "email"){
            ...
            $message = "New Order - ".ucwords($request->input('email'))." - ".$request->input('mobile')." is placed. Click <a href='".url('/admin/view_files')."/".$userRequest->user_uuid."' target='_blank'>here</a> to view";
